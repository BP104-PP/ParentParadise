...
JsonObject.class);
FriendsDaoMySqlImpl friendDao = new FriendsDaoMySqlImpl();
String action = jsonObject.get("action").getAsString();

if (action.equals("getAll")) {
int relation_member_no = jsonObject.get("relation_member_no").getAsInt();
List<Friend> friends = friendDao.getAll(relation_member_no);
...
throws ServletException, IOException {
FriendsDaoMySqlImpl friendDAO = new FriendsDaoMySqlImpl();
List<Friend> friends = friendDAO.getAll(1);
