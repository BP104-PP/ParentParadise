...
public class ActHistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvHistoryList.setLayoutManager(
    ...
    private void showHistoryActs() {
        ...
        if (Common.networkConnected(getActivity())) {
            ...
            try {
                ...
                jsonObject.addProperty("action", "getHistory");
            ...
            if (actsList == null || actsList.isEmpty()) {
                Common.showToast(getActivity(), "尚無歷史活動");
            } else {
                rvHistoryList.setAdapter(new ActListAdapter(getActivity(), actsList));
            }
        } else {
    ...
    private class ActListAdapter extends
        ...
        @Override
        public void onBindViewHolder(ActListAdapter.MyViewHolder viewHolder, int position) {
